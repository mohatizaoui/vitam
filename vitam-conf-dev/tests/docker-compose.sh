...
curl -XPUT -H 'Content-Type: application/json' http://localhost:9200/_index_template/default -d '{"index_patterns": ["*"], "priority": 1,"template": { "settings": {"index.number_of_shards": "1", "index.number_of_replicas": "0"}}}'
